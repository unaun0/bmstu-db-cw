...
public protocol IMembershipPurchaseService: Sendable {
    func purchase(_ dto: MembershipPurchaseDTO) async throws -> Payment
    func completePurchase(paymentId: UUID) async throws -> Membership
