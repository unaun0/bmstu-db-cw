//
//  UserAttendanceController.swift
//  Backend
//
...
public final class UserAttendanceController: RouteCollection {
    private let attendanceService: IUserAttendanceService
    ...
    public init(
        attendanceService: IUserAttendanceService,
...
extension UserAttendanceController {
    @Sendable
...
extension UserAttendanceController: @unchecked Sendable {}
